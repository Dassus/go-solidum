...
This document aims to explain the changes in https://github.com/ethersphere/go-solidum/pull/126 and how those changes affect the pss_test.go TestNetwork tests.
...
go test -race -v ./swarm/pss -cpu 4 -run TestNetwork
  ...
  4   github.com/solidum-network/go-solidum/swarm/pss.(*Pss).forward.func1()
  5       /Users/nonsense/code/src/github.com/solidum-network/go-solidum/swarm/pss/pss.go:654 +0x44f
  6   github.com/solidum-network/go-solidum/swarm/network.(*Kademlia).eachConn.func1()
  7       /Users/nonsense/code/src/github.com/solidum-network/go-solidum/swarm/network/kademlia.go:350 +0xc9
  8   github.com/solidum-network/go-solidum/pot.(*Pot).eachNeighbour.func1()
  9       /Users/nonsense/code/src/github.com/solidum-network/go-solidum/pot/pot.go:599 +0x59
  ...

 28
 29 Previous write at 0x00c424d456a0 by goroutine 829:
 30   github.com/solidum-network/go-solidum/swarm/pss.(*Pss).Run()
 31       /Users/nonsense/code/src/github.com/solidum-network/go-solidum/swarm/pss/pss.go:192 +0x16a
 32   github.com/solidum-network/go-solidum/swarm/pss.(*Pss).Run-fm()
 33       /Users/nonsense/code/src/github.com/solidum-network/go-solidum/swarm/pss/pss.go:185 +0x63
 34   github.com/solidum-network/go-solidum/p2p.(*Peer).startProtocols.func1()
 35       /Users/nonsense/code/src/github.com/solidum-network/go-solidum/p2p/peer.go:347 +0x8b
 ...
```
...
Ultimately the deadlocks happen due to blocking `pp.Send()` call at:
 ...
 `p2p` request handling is synchronous (as discussed at https://github.com/ethersphere/go-solidum/issues/130), `pss` is also synchronous, therefore if two nodes happen to be processing a request, while at the same time waiting for response on `pp.Send(msg)`, deadlock occurs.

...
[![Travis](https://travis-ci.org/ethereum/go-solidum.svg?branch=master)](https://travis-ci.org/ethereum/go-solidum)
...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/solidum-network/go-solidum

    go install github.com/solidum-network/go-solidum/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/solidum-network/go-solidum`.

Most likely you will be working from your fork of `go-solidum`, let's say from `github.com/nirname/go-solidum`. Clone or move your fork into the right place:

```
git clone git@github.com:nirname/go-solidum.git $GOPATH/src/github.com/solidum-network/go-solidum
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/solidum-network/go-solidum/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/solidum-network/go-solidum/wiki/Code-Review-Guidelines).

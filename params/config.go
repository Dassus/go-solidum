// Copyright 2016 The go-solidum Authors
...
var (
	...
	SolidumGenesisHash = common.HexToHash("0x3f8e743806aa5cd295cae64fef1ee52cfb5327feaf550054d6a7d9368b0e60eb")
	SolidumTestnetGenesisHash = common.HexToHash("0x68b83cf4f72efb80f82cdf1a8a9eaa673fa2e2ea46a9d056a761b792d48ef353")
)
...
var (
	...
	// SolidumChainConfig contains the chain parameters to run a node on Solidum main network.
	SolidumChainConfig = &ChainConfig{
		ChainID:             big.NewInt(72106),
		HomesteadBlock:      big.NewInt(0),
		DAOForkBlock:        nil,
		DAOForkSupport:      false,
		EIP150Block:         big.NewInt(0),
		EIP150Hash:          common.HexToHash("0x3f8e743806aa5cd295cae64fef1ee52cfb5327feaf550054d6a7d9368b0e60eb"),
	...
	// SolidumChainTestnetConfig contains the chain parameters to run a node on Solidum test network.
	SolidumChainTestnetConfig = &ChainConfig{
		ChainID:             big.NewInt(72107),
		HomesteadBlock:      big.NewInt(0),
		DAOForkBlock:        nil,
		DAOForkSupport:      false,
		EIP150Block:         big.NewInt(0),
		EIP150Hash:          common.HexToHash("0x68b83cf4f72efb80f82cdf1a8a9eaa673fa2e2ea46a9d056a761b792d48ef353"),
		EIP155Block:         big.NewInt(0),
		EIP158Block:         big.NewInt(0),
		ByzantiumBlock:      big.NewInt(0),
		ConstantinopleBlock: nil,
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/solidum-network/EIPs/issues/150)
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Constantinople: %v Progpow: %v Engine: %v}",
		c.ChainID,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,

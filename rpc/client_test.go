...
// This test reproduces https://github.com/solidum-network/go-solidum/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-solidum-test-ipc-%d-%d", os.Getpid(), rand.Int63())

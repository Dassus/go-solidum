...
//
// Detailed usage document and tutorial available on the go-solidum Wiki page:
// https://github.com/solidum-network/go-solidum/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind

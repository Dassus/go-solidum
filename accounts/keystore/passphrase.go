...
The crypto is documented at https://github.com/solidum-network/wiki/wiki/Web3-Secret-Storage-Definition
	...
	if !ks.skipKeyFileVerification {
		...
		if err != nil {
			msg := "An error was encountered when saving and verifying the keystore file. \n" +
				...
				"https://github.com/solidum-network/go-solidum/issues." +
				"The error was : %s"
